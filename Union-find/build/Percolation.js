...
const QuickUnionFind_1 = __importDefault(require("./QuickUnionFind"));
class Percolation {
    constructor(N) {
        this.N = N;
        this.uf = new QuickUnionFind_1.default(N * N + 2);
        this.ufPerc = new QuickUnionFind_1.default(N * N + 2);
        this.top = N * N;
        this.bottom = N * N + 1;
